...
function GoogleLogo() {
  return (
    <svg width="17" height="17" viewBox="0 0 48 48" className="shrink-0" aria-hidden>
...
function GithubLogo() {
  return (
    <svg width="18" height="18" viewBox="0 0 16 16" className="shrink-0" fill="#e9e9ee" aria-hidden>
